...
const Instructions = () => {
  return (
    <section className='border-b-2 border-Eggshell px-10 py-8 space-y-5 w-full'>
        <h2 className='font-Young text-2xl text-Nutmeg'>Instructions</h2>
        <ul className='list-decimal list-inside space-y-2 text-Wenge-Brown font-Outfit'>
